...
// ยี่ห้อที่บริษัทขายจริง (เรียงตามจำนวนที่ขาย) — STAXX/ROCKMAN/เจนบรรเจิด = ล็อตตู้ ข้ามขั้นรับรถ
// ⚠️ ROCKMAN = ยี่ห้อ · CNC = ชื่อบริษัทผู้ขายของยี่ห้อนี้ (ข้อมูลเก่าบางส่วนกรอก CNC ไว้ในช่องยี่ห้อ)
export const BRANDS = ["HELI", "STAXX", "ROCKMAN", "HANGCHA", "EP", "เจนบรรเจิด", "TOYOTA", "MITSUBISHI", "KOMATSU", "LINDE"];
